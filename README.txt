...
<head>
  ...
  <title>Mini Empires – TC, Drop-off, Mehrfachauswahl</title>
  ...
  <style>
    ...
    .btn{background:var(--panel);border:1px solid #2f3640;border-radius:14px;padding:9px 13px;font-weight:800;box-shadow:0 3px 0 rgba(0,0,0,.3);min-width:120px;text-align:center}
